...
XLSX = r"F:/题库输入表格/CIE P3 录入/24_MJ_33.xlsx"
...
# 章节（模板列空，按内容判定；Q2 驻点→Differentiation，Q9 微分方程→Differential equations）
CHAPTER = {
    1:  "Logarithmic and exponential functions",
    2:  "Differentiation",                                   # stationary point
    3:  "Complex numbers",
    4:  "Logarithmic and exponential functions",             # ln y vs x straight line
    5:  "Algebra (partial fractions and binomial expansions)",
    6:  "Complex numbers",                                   # Argand region
    7:  "Algebra (factor theorem and remainder theorem)",
    8:  "Trigonometry",                                      # R cos(2x+alpha) form
    9:  "Differential equations",                            # dx/dt DE
    10: "Vectors",
    11: "Integration",                                       # trig substitution integral
}
DIFF = {1:3, 2:3, 3:3, 4:2, 5:2, 6:3, 7:3, 8:4, 9:4, 10:4, 11:3}
