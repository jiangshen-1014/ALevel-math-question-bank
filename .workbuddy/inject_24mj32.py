...
# 章节（模板列空，按内容判定）
CHAPTER = {
    1:  "Algebra (modulus functions)",                       # |x-2a| graph + inequality
    2:  "Algebra (partial fractions and binomial expansions)",
    3:  "Logarithmic and exponential functions",             # straight line from a^{2y-1}=b^{x-y}
    4:  "Differentiation",                                   # implicit diff, gradient at y=1
    5:  "Numerical solution of equations",                   # root interval + iteration
    6:  ["Differentiation", "Integration"],                  # max point M + integral
    7:  "Integration",                                       # identity + integral
    8:  "Vectors",
    9:  "Complex numbers",
    10: "Differential equations",                            # sec^3 diff step + solve DE
}
DIFF = {1:2, 2:2, 3:3, 4:3, 5:3, 6:4, 7:4, 8:4, 9:4, 10:4}

# DISPIMG id -> media file (resolved from cellimages.xml + rels)
DISPIMG_MEDIA = {
    'ID_6FB40FFE7DD647D2B1592E8A5B12F4FD': 'image1.png',  # Q6
}
