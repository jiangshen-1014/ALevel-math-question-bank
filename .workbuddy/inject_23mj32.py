...
CHAPTER = {
    1:  "Algebra (modulus functions)",                      # |5x-3|<2|3x-7|
    2:  "Logarithmic and exponential functions",            # ln equation
    3:  "Complex numbers",                                  # Argand locus + least |z|
    4:  "Trigonometry",                                     # 2cos x - cos(x/2) = 1
    5:  "Complex numbers",                                  # complex alpha, arg alpha
    6:  "Numerical solution of equations",                  # root alpha + iteration
    7:  "Differentiation",                                  # implicit diff, tangent parallel
    8:  "Differential equations",                           # separable DE
    9:  "Algebra (partial fractions and binomial expansions)",  # partial fractions + integral
    10: ["Differentiation", "Integration"],                 # max point M + area by substitution
    11: "Vectors",                                          # two lines, foot of perpendicular
}
DIFF = {1:2, 2:2, 3:3, 4:3, 5:3, 6:4, 7:4, 8:4, 9:4, 10:4, 11:4}

# DISPIMG id -> media file (resolved from cellimages.xml + rels)
DISPIMG_MEDIA = {
    'ID_CA2DB0FB90834A8399E81EE58C3873BC': 'image1.png',  # Q10
}
