...
CHAPTER = {
    1:  "Logarithmic and exponential functions",            # e^{2x} - e^{-2x} = 5
    2:  "Algebra (modulus functions)",                      # |2x+3| graph + inequality
    3:  "Algebra (partial fractions and binomial expansions)",  # binomial coef x^3
    4:  "Trigonometry",                                     # trig identity + solve
    5:  "Differentiation",                                  # implicit diff, tangent parallel y-axis
    6:  "Vectors",                                          # parallelogram ABCD
    7:  "Differential equations",                           # separable DE
    8:  "Algebra (partial fractions and binomial expansions)",  # partial fractions + integral
    9:  "Numerical solution of equations",                  # integral = 1/8, verify + iteration
    10: "Algebra (factor theorem and remainder theorem)",   # polynomial factor + complex roots
}
DIFF = {1:2, 2:2, 3:2, 4:3, 5:4, 6:4, 7:4, 8:4, 9:4, 10:4}

DISPIMG_MEDIA = {}  # none in this file
