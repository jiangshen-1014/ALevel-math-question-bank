...
XLSX = r"F:/题库输入表格/CIE P3 录入/23_FM_32.xlsx"
...
CHAPTER = {
    1:  "Logarithmic and exponential functions",            # ln -> express y in x
    2:  "Complex numbers",                                  # Argand region + least arg z
    3:  "Algebra (factor theorem and remainder theorem)",   # polynomial division remainder
    4:  "Complex numbers",                                  # complex equation
    5:  "Differentiation",                                  # parametric dy/dx + normal
    6:  "Trigonometry",                                     # R cos form + solve
    7:  "Numerical solution of equations",                  # sector root + iteration
    8:  ["Differentiation", "Integration"],                 # x^3 ln x min + area
    9:  "Differential equations",                           # separable DE
    10: "Vectors",                                          # angle + line + point
    11: "Algebra (partial fractions and binomial expansions)",  # partial fractions + integral
}
DIFF = {1:2, 2:3, 3:3, 4:4, 5:4, 6:4, 7:4, 8:4, 9:4, 10:4, 11:4}

# DISPIMG id -> media file (resolved from cellimages.xml + rels)
DISPIMG_MEDIA = {
    'ID_C9B9FA46F2D641BBBC0D70EFC2341413': 'image1.png',  # Q7
    'ID_6C4C52ABEE05412A90E177C8DA47D18A': 'image2.png',  # Q8
}
