...
XLSX = r"F:/题库输入表格/CIE P3 录入/24_MJ_31.xlsx"
...
# 章节（模板列空，按内容判定）
CHAPTER = {
    1:  "Algebra (partial fractions and binomial expansions)",  # binomial expansion
    2:  "Logarithmic and exponential functions",
    3:  "Logarithmic and exponential functions",                # y vs ln x straight line
    4:  "Complex numbers",
    5:  "Differentiation",                                      # dy/dx + stationary points
    6:  "Numerical solution of equations",                       # root alpha + iteration
    7:  "Complex numbers",                                      # Argand loci
    8:  "Integration",                                          # substitution integral
    9:  "Vectors",
    10: "Integration",                                          # dy/dx step + integration by parts
    11: "Differential equations",                              # logistic growth DE
}
DIFF = {1:2, 2:2, 3:2, 4:3, 5:3, 6:4, 7:3, 8:4, 9:4, 10:4, 11:4}

# DISPIMG id -> media file (resolved from cellimages.xml + rels)
DISPIMG_MEDIA = {
    'ID_A35D9A6F75CC4D8B87237B7EF1198601': 'image1.png',  # Q3
}
